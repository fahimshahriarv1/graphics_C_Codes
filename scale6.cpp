#include<stdio.h>
#include<math.h> #include<graphics.h> using namespace std;
...
int main()
{
    ...
    mdx-=250;
    line(mdx+x1*factor_for_display,mdy-y1*factor_for_display,mdx+x2*factor_for_display,mdyy2*factor_for_display);
    line(mdx+x2*factor_for_display,mdy-y2*factor_for_display,mdx+x3*factor_for_display,mdyy3*factor_for_display);
    line(mdx+x3*factor_for_display,mdy-y3*factor_for_display,mdx+x4*factor_for_display,mdyy4*factor_for_display);
    line(mdx+x1*factor_for_display,mdy-y1*factor_for_display,mdx+x4*factor_for_display,mdyy4*factor_for_display);

    int textx=x1,texty=y1+80;

    outtextxy(textx,texty,"Original Shape:");
    //for clockwise rotation     double theta=30;
